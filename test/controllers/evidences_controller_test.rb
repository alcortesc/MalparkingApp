...
class EvidencesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evidence" do
    assert_difference('Evidence.count') do
      post evidences_url, params: { evidence: { nombre_evidencia: @evidence.nombre_evidencia } }
    end
  ...
  test "should update evidence" do
    patch evidence_url(@evidence), params: { evidence: { nombre_evidencia: @evidence.nombre_evidencia } }
