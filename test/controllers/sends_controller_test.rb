...
class SendsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create send" do
    assert_difference('Send.count') do
      post sends_url, params: { send: { fecha_hora: @send.fecha_hora, notification_id: @send.notification_id, report_id: @send.report_id } }
    end
  ...
  test "should update send" do
    patch send_url(@send), params: { send: { fecha_hora: @send.fecha_hora, notification_id: @send.notification_id, report_id: @send.report_id } }
